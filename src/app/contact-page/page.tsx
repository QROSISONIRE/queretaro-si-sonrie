  ...
  return (
    <HydrateClient>
      <div className={`h-auto w-full ${inter.className}`}>
        ...
        <div className="relative left-1/2 top-[80%] flex h-[40%] w-[40%] -translate-x-1/2 -translate-y-1/2 transform flex-col items-center justify-center rounded-2xl border border-white/20 bg-white bg-opacity-30 p-5 text-center text-black shadow-lg backdrop-blur-lg">
      ...
      <section className="flex w-full justify-center items-center">
        ...
        <div className="flex-1 max-w-[45%] px-20">
          <ContactForm />
        </div>
      </section>
